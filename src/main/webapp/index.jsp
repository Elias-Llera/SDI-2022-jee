...
<div class="container" id="main-container"><h2>Productos</h2>
    <div class="row ">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
            <div><img src="images/iconfinder_orange.png"/>
                <div>Naranjas</div>
                <a href="AddToShoppingCart?product=orange" class="btn btn-default"> 2.10 € </a></div>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
            <div><img src="./images/iconfinder_bread.png"/>
                <div>Pan</div>
                <a href="AddToShoppingCart?product=breadd" class="btn btn-default"> 0.80 € </a></div>
        </div>
    </div>
</div>
</body>
